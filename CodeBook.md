...
concatinate the training and the test sets with the command rbind and then concatenate the train and test tables by rows with the rbind command. <br />
...
Load activity labels and then use the command merge to merge the tidy data set with the activity label. The result needed to be set again in the right order and that is been done with the command select. <br />
